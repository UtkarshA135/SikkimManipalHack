...
import 'package:manipalhack/screens/smartConnect/display_crop_ctrl.dart';
...
class BidPage extends StatefulWidget {
  ...
  const BidPage(this.imgUrl, this.MSP, this.cropName, this.cropDescription,
      this.cropQuantity, this.ownerContactInfo);
